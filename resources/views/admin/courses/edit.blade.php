        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('teacher', trans('quickadmin.courses.fields.teacher').'', ['class' => 'control-label']) !!}
                    ...
                    {!! Form::select('teacher[]', $teachers, old('teacher') ? old('teacher') : $course->teacher->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-teacher' ]) !!}
