                    ...
                    <form class="form-horizontal"
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <a href="/auth/google" 
 class="btn btn-default " style="margin: 5px;" align="right"> 
<i class="fa fa-google-plus-official" style="font-size: 16px; margin:5px; color:red"></i> Continue with Google </a>
                            </div>
